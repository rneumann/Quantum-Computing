...
Strukturell orientiert sich das Quantenschaltkreismodell an digitalen Schaltungen. Klassische Schaltkreise bestehen aus Leitungen, Gattern und Bits mit den Zuständen 0 und 1. Analog dazu bestehen Quantenschaltkreise aus Qubit-Leitungen, Gattern und Quantenbits (Qubits). Jede Leitung repräsentiert dabei ein Qubit und jedes Gatter eine unitäre Transformation auf eines oder mehrere Qubits. Die Struktur des Quantenschaltkreises wird meist visuell dargestellt, um die Reihenfolge der angewendeten Operationen und die daran beteiligten Qubits zu verdeutlichen.
...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=0.9\linewidth]{quantum-software/quantum_programming_landscape.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{quantum-software/qiskit_architecture.png}
...
Die Zwischensprache OpenQASM dient als Brücke und erlaubt die serielle und strukturierte Repräsentation von Schaltungen. \autocite{cross_open_2017}
...
\node[layerbox] (l1) at (0, 0) {Quantenalgorithmen};
\node[layerbox] (l2) at (0, -1) {Programmiersprachen};
\node[layerbox] (l2) at (0, -2) {SDKs und Frameworks};
...
\begin{figure}[ht!]
  \centering
  \includegraphics[width=0.8\textwidth]{quantum-software/qcraft_architecture.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=0.75\linewidth]{quantum-software/visualize_measurements.png}
