...
\centering
\small
\begin{tabular}{|>{\bfseries}m{3cm}|m{3.5cm}|m{3.5cm}|m{3.5cm}|}
\hline
...
Hardwareabhängigkeit & Sehr hoch (vollständige Quantenprozessorabhängigkeit) & Mittel (anpassbar an NISQ-Bedingungen) & Gering (oft klassische Ausführung möglich) \\
\hline
