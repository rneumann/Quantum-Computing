...
Ziel ist es also, eine zusammengesetzte Zahl \( N = pq \) effizient zu faktorisieren. Klassische Algorithmen benötigen dafür im Allgemeinen exponentielle Laufzeit. Shor's Algorithmus nutzt die Periodizität der Funktion
