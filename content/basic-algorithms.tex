...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.9\textwidth]{images/3-qubits-grover.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.2\textwidth]{images/toffoli.png}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.4\textwidth]{images/grover-2-iteration.png}
